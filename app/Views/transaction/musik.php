...
<main class="topup-main">
    ...
    <div class="container">
        ...
        <div class="transaction-label">
            <img src="<?= base_url('assets/icons/Musik.png') ?>" alt="Musik">
            <span>Musik</span>
        </div> 
        <form action="<?= base_url('musik') ?>" method="post" class="transaction-form">
            <div class="input-group-transaction">
                <span class="input-icon-transaction">
                    <i class="fa-solid fa-money-bill"></i>
                </span>
                <input type="number" name="nominal" placeholder="Masukan Nominal Pembayaran Musik">
            </div>
            <button type="button" class="submit-btn musik-submit-btn" data-endpoint="<?= base_url('musik') ?>" data-label="Musik" id="musik-submit-btn">
                Bayar
            </button>
        </form>
    </div>
