...
<main class="topup-main">
    ...
    <div class="container">
        ...
        <div class="transaction-label">
            <img src="<?= base_url('assets/icons/Zakat.png') ?>" alt="Zakat">
            <span>Zakat</span>
        </div> 
        <form action="<?= base_url('zakat') ?>" method="post" class="transaction-form">
            <div class="input-group-transaction">
                <span class="input-icon-transaction">
                    <i class="fa-solid fa-money-bill"></i>
                </span>
                <input type="number" name="nominal" placeholder="Masukan Nominal Pembayaran Zakat">
            </div>
            <button type="button" class="submit-btn zakat-submit-btn" data-endpoint="<?= base_url('zakat') ?>" data-label="Zakat" id="zakat-submit-btn">
                Bayar
            </button>
        </form>
    </div>
