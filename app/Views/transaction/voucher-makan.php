...
<main class="topup-main">
    ...
    <div class="container">
        ...
        <div class="transaction-label">
            <img src="<?= base_url('assets/icons/Voucher%20Makanan.png') ?>" alt="Voucher Makanan">
            <span>Voucher Makanan</span>
        </div> 
        <form action="<?= base_url('voucher-makanan') ?>" method="post" class="transaction-form">
            <div class="input-group-transaction">
                <span class="input-icon-transaction">
                    <i class="fa-solid fa-money-bill"></i>
                </span>
                <input type="number" name="nominal" placeholder="Masukan Nominal Pembayaran Voucher Makanan">
            </div>
            <button type="button" class="submit-btn voucher-makanan-submit-btn" data-endpoint="<?= base_url('voucher-makanan') ?>" data-label="Voucher Makanan" id="voucher-makanan-submit-btn">
                Bayar
            </button>
        </form>
    </div>
