...
<main class="topup-main">
    ...
    <div class="container">
        ...
        <div class="transaction-label">
            <img src="<?= base_url('assets/icons/Game.png') ?>" alt="Game">
            <span>Voucher Game</span>
        </div> 
        <form action="<?= base_url('voucher-game') ?>" method="post" class="transaction-form">
            <div class="input-group-transaction">
                <span class="input-icon-transaction">
                    <i class="fa-solid fa-money-bill"></i>
                </span>
                <input type="number" name="nominal" placeholder="Masukan Nominal Pembayaran Voucher Game">
            </div>
            <button type="button" class="submit-btn voucher-game-submit-btn" data-endpoint="<?= base_url('voucher-game') ?>" data-label="Voucher Game" id="voucher-game-submit-btn">
                Bayar
            </button>
        </form>
    </div>
