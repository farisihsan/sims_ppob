...
<main class="topup-main">
    ...
    <div class="container">
        ...
        <div class="transaction-label">
            <img src="<?= base_url('assets/icons/pgn.png') ?>" alt="PGN">
            <span>PGN</span>
        </div> 
        <form action="<?= base_url('pgn') ?>" method="post" class="transaction-form">
            <div class="input-group-transaction">
                <span class="input-icon-transaction">
                    <i class="fa-solid fa-money-bill"></i>
                </span>
                <input type="number" name="nominal" placeholder="Masukan Nominal Pembayaran PGN">
            </div>
            <button type="button" class="submit-btn pgn-submit-btn" data-endpoint="<?= base_url('pgn') ?>" data-label="PGN" id="pgn-submit-btn">
                Bayar
            </button>
        </form>
    </div>
