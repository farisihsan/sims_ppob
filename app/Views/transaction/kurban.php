...
<main class="topup-main">
    ...
    <div class="container">
        ...
        <div class="transaction-label">
            <img src="<?= base_url('assets/icons/Kurban.png') ?>" alt="Kurban">
            <span>Kurban</span>
        </div> 
        <form action="<?= base_url('kurban') ?>" method="post" class="transaction-form">
            ...
            <button type="button" class="submit-btn kurban-submit-btn" data-endpoint="<?= base_url('kurban') ?>" data-label="Kurban" id="kurban-submit-btn">
                Bayar
            </button>
        </form>
    </div>
