...
<main class="topup-main">
    ...
    <div class="container">
        ...
        <div class="transaction-label">
            <img src="<?= base_url('assets/icons/Paket%20Data.png') ?>" alt="Paket Data">
            <span>Paket Data</span>
        </div> 
        <form action="<?= base_url('paket-data') ?>" method="post" class="transaction-form">
            ...
            <button type="button" class="submit-btn paket-data-submit-btn" data-endpoint="<?= base_url('paket-data') ?>" data-label="Paket Data" id="paket-data-submit-btn">
                Bayar
            </button>
        </form>
    </div>
