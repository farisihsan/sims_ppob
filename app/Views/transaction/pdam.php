...
<main class="topup-main">
    ...
    <div class="container">
        ...
        <div class="transaction-label">
            <img src="<?= base_url('assets/icons/pdam.png') ?>" alt="Pulsa">
            <span>PDAM</span>
        </div> 
        <form action="<?= base_url('pdam') ?>" method="post" class="transaction-form">
            ...
            <button type="button" class="submit-btn pdam-submit-btn" data-endpoint="<?= base_url('pdam') ?>" data-label="Pdam" id="pdam-submit-btn">Bayar</button>
        </form>
    </div>
</main>
